...
uv run .\Plugins\SpeechGen\Tools\ModelBuild\build_kokoro_mixed.py `
  ...
  --voices-dir ".\Saved\SpeechGen\Runtimes\Kokoro\Win64\v1.0-cpu-mixed.2\voices" `
  --config ".\Saved\SpeechGen\Runtimes\Kokoro\Win64\v1.0-cpu-mixed.2\kokoro_config.json" `
