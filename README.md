...
SpeechGen is an Unreal Engine 5.7 plugin for fully local English speech synthesis. It runs Kokoro-82M v1.0 Q8 through Unreal's `NNERuntimeORTCpu`, keeping GPU memory available for the language model.
